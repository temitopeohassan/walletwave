...
exports.regenerateApiSecret = exports.deleteApiKey = exports.updateApiKey = exports.getApiKey = exports.listApiKeys = exports.createApiKey = void 0;
...
const listApiKeys = async (req, res) => {
    try {
        ...
        const apiKeys = await ApiKey_1.ApiKey.find(query)
...
const getApiKey = async (req, res) => {
    try {
        const { id } = req.params;
        const requestingUserId = req.userId;
        const apiKey = await ApiKey_1.ApiKey.findById(id).exec();
        if (!apiKey) {
...
const deleteApiKey = async (req, res) => {
    try {
        ...
        await ApiKey_1.ApiKey.findByIdAndDelete(id).exec();
        res.json({
...
exports.regenerateApiSecret = regenerateApiSecret;
